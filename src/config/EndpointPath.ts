...
import { CLIENT_REGISTRATION_PATH } from '@vecrea/au3te-ts-server/handler.client-registration';
/**
...
export class EndpointPath {
  ...
  static readonly clientRegistrationPath = CLIENT_REGISTRATION_PATH;
